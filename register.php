							...
							<div class="form-group">
								<?php
									if (isset($_GET['referral_code'])) {
										$referral_code = mysqli_real_escape_string($con, $_GET['referral_code']);
									}
									else {
										$referral_code = "";
									}
								?>
								<input class="form-control" name="referrer" id="referral_code" placeholder="REFERRAL CODE" type="text" value="<?php echo $referral_code; ?>">
							</div>
							<!-- Input Field Ends -->
