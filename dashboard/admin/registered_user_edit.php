        ...
        <div class="card">
          ...
          <div style="float: left;">
            ...
            <div style="float: right;">
              ...
              <a href="./registered_users.php" class="btn btn-sm btn-danger">Back</a>
            </div>
          </div>
          <div class="card-body">
            <div class="row">
                    ...
                    if (isset($_GET['id'])) {
                      ...
                      if (mysqli_num_rows($result) > 0) {
                        foreach($result as $row) {
                          ...
                          <!-- Input Field Starts -->
                          <div class="form-group">
                            <input class="form-control" value="<?php echo $row['phone'] ?>" name="phonenumber" id="phoneNumber" placeholder="PHONE NUMBER" type="text">
                          </div>
                          <!-- Input Field Ends -->
            
                          <!-- Input Field Starts -->
                          <div class="form-group">
                            <input class="form-control" value="<?php echo $row['password'] ?>" name="password" id="password" placeholder="PASSWORD" type="password">
                          </div>
                          <!-- Input Field Ends -->
                          <!-- Input Field Starts -->
                          <div class="form-group">
                            <input class="form-control" value="<?php echo $row['cpassword'] ?>" name="cpassword" id="confirmPassword" placeholder="CONFIRM PASSWORD" type="password">
                          </div>
                          ...
                          <div class="form-group">
                            <select class="form-control" value="<?php echo $row['country'] ?>" name="country">
