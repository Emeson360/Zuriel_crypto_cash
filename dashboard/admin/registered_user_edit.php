    ...
    <div class="row">
      <div class="d-flex" style="justify-content: center;">
        <div class="col-lg-10 col-xlg-10 col-md-10">
          <div class="card">
            <!--card header  -->
            <div class="nav nav-tabs profile-tab d-flex" style="justify-content: space-between; align-items: center; background-color: #121417"  role="tablist" >
              <li  class="nav-item" style="background-color: #121417; color: #E78A1A; padding: 20px; font-size: 20px;"> Edit - Registered users</li>
              <li style="float: right;" class="nav-item mr-30" style="background-color: #121417; color: #E78A1A; padding: 20px; font-size: 20px;"><a href="./manage_users.php" class="btn btn-sm btn-danger">Back</a></li>
            </div>
                        ...
                        foreach($result as $row) {
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-12">
                                <select name="usertype" class="form-control" style="background-color: #24282F;">
