    ...
    <div class="scroll-sidebar">
      ...
      <nav class="sidebar-nav" style="background-color: #111;">
        <ul id="sidebarnav" style="padding-top: 30px;">
          <li><a href="../admin/index.php"><i class="fa fa-dashboard" style="margin-right: 10px;"></i><apan class="hide-menu"> Dashboard</apan></a></li>
          <li><a href="#"><i class="fa fa-dashboard" style="margin-right: 10px;"></i><apan class="hide-menu"> Deposite</apan></a></li>
          ...
          <!-- <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-account-settings mr-10"></i><span class="hide-menu">Apps</span></a>
